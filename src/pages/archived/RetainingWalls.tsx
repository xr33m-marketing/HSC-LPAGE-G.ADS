              ...
              <div className="bg-granite-dark p-6 rounded-lg border border-gray-600">
                ...
                <ul className="space-y-3">
                  <li className="flex items-center gap-2">
                    ...
                    <span className="text-gray-200">Soil testing</span>
                  </li>
                  <li className="flex items-center gap-2">
                    <Check className="text-green-400" size={20} />
                    <span className="text-gray-200">Drainage design</span>
                  </li>
                  <li className="flex items-center gap-2">
                    <Check className="text-green-400" size={20} />
                    <span className="text-gray-200">Foundation work</span>
                  </li>
                </ul>
              </div>
              <div className="bg-granite-dark p-6 rounded-lg border border-gray-600">
                ...
                <ul className="space-y-3">
                  <li className="flex items-center gap-2">
                    <Check className="text-green-400" size={20} />
                    <span className="text-gray-200">Premium blocks</span>
                  </li>
                  <li className="flex items-center gap-2">
                    <Check className="text-green-400" size={20} />
                    <span className="text-gray-200">Proper drainage</span>
                  </li>
                  <li className="flex items-center gap-2">
                    <Check className="text-green-400" size={20} />
